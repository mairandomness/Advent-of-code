...
class Game_state:
    def __init__(self, numbers, game_map, i):
        ...
        self.previous_droid_position = (initial, initial)
...
def save_map(game):
    with open('maze', 'w') as filehandle:
        for line in game.game_map:
            filehandle.write('%s\n' % str(line))


def find_whole_map(game, stdscr):
